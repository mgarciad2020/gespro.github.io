...
<body>
    ...
    <div class="container margin-bottom">
        <form class="form-horizontal  row" method="GET" action="../../Controlador/TrabajadorAddTrabajadorTarea.php">
            <br>
            <div class="mb-3">
                <div class="mb-3">
                ...
                <select class="form-control" name="id_tarea" id="AllIdByProyecto">
                </select>
                <br>
